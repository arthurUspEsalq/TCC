...
dados_base1 = {
    'Data_Hora': ["2023-10-05 14:00:00", "2023-10-05 15:30:00", "2023-10-05 16:45:00", "2023-10-06 08:00:00"],
    'Duracao_Segundos': [3600, 2700, 1800, 3600]
}

# Exemplo de dados da segunda base
dados_base2 = {
    'Data': ["05/10/2023", "05/10/2023", "05/10/2023", "06/10/2023", "06/10/2023", "06/10/2023"],
    'Hora_Inicio': ["14:00", "15:15", "16:30", "15:00", "18:00", "07:50"],
    'Duracao_Minutos': [60, 45, 60, 45, 60, 120]
}
...
# Adicione colunas no DataFrame da primeira base para marcar se o evento ocorre durante um evento da segunda base
df_base1['Ocorre_Durante_Evento_Base2'] = False
df_base1['Novo_Evento'] = False  # Coluna para a nova condição
...
for index_base1, row_base1 in df_base1.iterrows():
    ...
    for index_base2, row_base2 in df_base2.iterrows():
        ...
        if data_hora_evento1 <= data_hora_evento2 + timedelta(minutes=duracao_evento2) \
                and data_hora_evento1 + timedelta(seconds=duracao_evento1) >= data_hora_evento2:
            df_base1.at[index_base1, 'Novo_Evento'] = True
